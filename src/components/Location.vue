    ...
    <main class="container">
        <div class="main-right">
            ...
            <div class="main-block">
                <div v-for="location in locations" :key="location.id" class="card-series">
            ...
            <div class="main-bottom">
                <p class="main-prev main-func" @click="prevPage" :disabled="currentPage === 1">PREVIOUS</p>
                <p class="main-next main-func" @click="nextPage" :disabled="currentPage === maxPages">NEXT</p>
            </div>
        </div>
    </main>
